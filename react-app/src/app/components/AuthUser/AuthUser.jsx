...
export const AuthUser = () => {
    ...
    return(
        <div className="w-full h-screen flex flex-col items-center pt-10 bg-gray-200">
            <div className="w-3/5 h-60 bg-white shadow drop-shadow-2xl mt-2 flex items-center flex-col rounded-xl px-2">
                <div className=" w-full h-60 flex pb-4 justify-center items-center text-center pt-2 flex-col">
                        <Avatar className="w-24 h-24 -translate-y-12 bg-indigo-400" src={JSON.parse(user).user?.image}/>
                    ...
                    <div className="pt-2 grid grid-cols-2 gap-3 justify-items-center">
                        ...
                        <div className="flex gap-2">
                            ...
                            {new Date(JSON.parse(user).user?.createdAt).toDateString()}
                        </div>
                    </div>
                </div>
            </div>
